...
export default function Navbar() {
  return (
    <div className="flex flex-row space-x-4 mx-0 px-10 py-2 m-4 mt-0 w-100 bg-gray-800 drop-shadow-xl">
      <p className="flex flex-row items-center space-x-2 text-purple-400 whitespace-nowrap text-xl "> Visual Vibes </p>
