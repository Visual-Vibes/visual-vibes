  ...
  return (
    <div className="flex items-center">
      <div className="flex flex-col items-center justify-center my-4 mx-10 text-gray-300 bg-gray-900 p-2 rounded-lg">
        ...
        <div className="relative w-72 h-72 bg-white rounded-full shadow-lg">
          <svg className="absolute w-full h-full" viewBox="-8 -5 240 245">
            <path
              className="numbers"
          ...
          <div
            className="absolute w-1/2 h-1 bg-black bottom-1/2 left-0 transform origin-right mx-2"
            style={{ transform: `rotate(${hourDegrees}deg)` }}
          ></div>
        </div>
