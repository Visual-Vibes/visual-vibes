  ...
  return (
    <div className="flex items-center z-10">
      <div className="flex flex-col items-center justify-center my-4 mx-10 text-gray-300 bg-gray-900 p-2 rounded-lg">
          ...
          {/* Existing numbers and other elements... */}
        ...
        <div className="relative m-3 w-72 h-72 bg-white rounded-full shadow-lg border-4 border-black">
          <div
            className="absolute w-1/2 h-1 bg-blue-400 bottom-1/2 left-0 transform origin-right mx-0 mt-5"
            style={{ transform: `rotate(${hourDegrees}deg)`, filter: `hue-rotate(${hue}deg)` }}
          ></div>
          <svg className="absolute w-full h-full" viewBox="-8 -5 245 245">
            <circle cx="115" cy="118" r="106" fill="none" stroke="white" strokeWidth="35" />
            <path
              className="numbers"
        ...
        <div className="flex items-center bg-white align-items m-3">
